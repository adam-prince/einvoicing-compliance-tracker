...
export function App() {
    ...
    return (_jsxs(CarbonProvider, { children: [_jsx(GlobalStyle, {}), _jsxs("div", { className: "container", children: [_jsxs("div", { className: "row", style: { justifyContent: 'space-between', alignItems: 'center' }, children: [_jsxs("div", { children: [_jsx("h1", { style: { marginTop: 0 }, children: t('app_title') }), _jsx("p", { style: { color: '#9aa4b2', marginTop: -8 }, children: t('app_subtitle') })] }), _jsxs("div", { className: "row", "aria-label": "Application controls", style: { gap: 16, alignItems: 'flex-start', flexWrap: 'wrap' }, children: [_jsx("div", { style: { minWidth: '180px' }, children: _jsxs(Select, { label: t('label_language'), value: language, onChange: (e) => setLanguage(e.target.value), "aria-label": "Select application language", size: "medium", labelInline: false, children: [_jsx(Option, { value: "en-GB", text: "English (UK)" }), _jsx(Option, { value: "en-US", text: "English (US)" }), _jsx(Option, { value: "fr-FR", text: "Fran\u00E7ais" }), _jsx(Option, { value: "de-DE", text: "Deutsch" }), _jsx(Option, { value: "es-ES", text: "Espa\u00F1ol" })] }) }), _jsx("div", { style: { minWidth: '120px' }, children: _jsxs(Button, { onClick: openColumnManager, size: "medium", variant: "secondary", "aria-label": t('button_manage_columns') || 'Manage table columns', title: t('button_manage_columns') || 'Manage table columns', children: [_jsx("span", { style: { fontSize: '12px', marginRight: '6px' }, children: "\u2699\uFE0F" }), t('button_columns') || 'Columns'] }) })] })] }), loading ? (_jsx(LoadingSpinner, { message: t('loading_compliance') })) : (_jsx(_Fragment, { children: _jsxs("main", { id: "main", role: "main", tabIndex: -1, children: [_jsx(QuickStats, {}), _jsx("div", { className: "spacer" }), _jsx(Filters, {}), _jsx("div", { className: "spacer" }), _jsxs("div", { className: "row", style: { justifyContent: 'space-between', marginBottom: 8 }, children: [_jsx("div", { style: { color: '#9aa4b2' }, "aria-live": "polite", children: t('filters_total_countries', { count: countries.length }) }), _jsx(ExportButtons, {})] }), _jsx(CountryTable, {})] }) })), selected && (_jsx(CountryDetail, { country: selected, onClose: closeModal })), showColumnManager && (_jsx(ColumnManager, { columns: columnConfigs, onColumnsChange: handleColumnsChange, onClose: closeColumnManager }))] })] }));
}
