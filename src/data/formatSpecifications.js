...
export function getFormatSpecifications(formatName) {
...
export function getLegislationDocuments(legislationName) {
    // Try exact match first
...
export function getCountryFormats(countryCode) {
