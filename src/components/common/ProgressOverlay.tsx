...
export function ProgressOverlay({ visible, message, progress = 0, onClose }: Props) {
  ...
  return (
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby={titleId} aria-describedby={progressId}>
      <div className="modal" style={{ maxWidth: 480 }}>
        <header style={{ 
          ...
          <strong id={titleId}>Update in progress</strong>
          {onClose && (
            <button 
              onClick={onClose}
        ...
        <div style={{ padding: 16 }}>
          <p style={{ marginTop: 0, marginBottom: 16, minHeight: '1.5em' }} aria-live="polite">
            {message || 'Processing...'}
          </p>
          <div 
            role="progressbar"
