...
export const AriaUtils = {
   ...
   */
  setupModalAria(modal: HTMLElement, triggerElement: HTMLElement | null = null): void {
   ...
   */
  cleanupModalAria(modal: HTMLElement): void {
    const cleanup = (modal as any).__focusCleanup;
    if (cleanup) {
      cleanup();
      delete (modal as any).__focusCleanup;
    }
   ...
   */
  setupTableAria(table: HTMLElement, caption?: string): void {
